...
namespace LipingShare.LCLib.Asn1Processor
{
	...
	public class Asn1Util
	{
		...
		public static bool IsAsn1EncodedHexStr(string dataStr)
		{
			...
			try
			{
				...
				if (array.Length > 0)
				{
					...
					return asn1Node.LoadData(array);
				}
				return result;
			}
			catch
		...
		public static string GetTagName(byte tag)
		{
			...
			if ((tag & 0xC0) == 0)
			{
				text = (tag & 0x1F) switch
				{
					...
					4 => text + "OCTET STRING",
					5 => text + "NULL",
					6 => text + "OBJECT IDENTIFIER",
					7 => text + "OBJECT DESCRIPTOR",
					13 => text + "RELATIVE-OID",
					8 => text + "EXTERNAL",
					9 => text + "REAL",
					10 => text + "ENUMERATED",
					12 => text + "UTF8 STRING",
					16 => text + "SEQUENCE",
					17 => text + "SET",
					18 => text + "NUMERIC STRING",
					19 => text + "PRINTABLE STRING",
					20 => text + "T61 STRING",
					21 => text + "VIDEOTEXT STRING",
					22 => text + "IA5 STRING",
					23 => text + "UTC TIME",
					24 => text + "GENERALIZED TIME",
					25 => text + "GRAPHIC STRING",
					26 => text + "VISIBLE STRING",
					27 => text + "GENERAL STRING",
					28 => text + "UNIVERSAL STRING",
					30 => text + "BMP STRING",
					_ => text + "UNKNOWN TAG",
				};
			}
		...
		{
			RegistryKey registryKey = Registry.CurrentUser.OpenSubKey(path, writable: true);
			if (registryKey == null)
			{
